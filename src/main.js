...
//blockchain.createScenarioContract('Inbeslagname Auto').then(address => console.log(address));

// const scenarioContract = new blockchain.Scenario('0x0d603448d8409f2c4d14251bb17efc8dfd78fb0c');
// scenarioContract.newVersion(20170923, JSON.stringify(scenarioVersion));
//blockchain.createProcessContract('0x0d603448d8409f2c4d14251bb17efc8dfd78fb0c').then(address => console.log('process',address));
